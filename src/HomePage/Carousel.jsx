                ...
                <Carousel>
                    <Paper>
                        <CustomBox>
                            ...
                            <CustomBoxContent><img src={prod1.image} alt="" /></CustomBoxContent>
                    ...
                    <Paper>
                        <CustomBox>
                            ...
                            <CustomBoxContent><img src={prod2.image} alt="" /></CustomBoxContent>
                            <Button className="CheckButton">
                                Voir le produit
                            </Button>
                        </CustomBox>
                    ...
                    <Paper>
                        <CustomBox>
                            ...
                            <CustomBoxContent><img src={prod3.image} alt="" /></CustomBoxContent>
                            <Button className="CheckButton">
                                Voir le produit
                            </Button>
                        </CustomBox>
